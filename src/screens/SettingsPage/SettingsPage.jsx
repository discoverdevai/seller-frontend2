...
export const SettingsPage = () => {
  ...
  const tabItems = [
    { label: t("tabs.generalSettings"), id: "settings" },
    { label: t("tabs.users"), id: "users" },
    { label: t("tabs.orders"), id: "orders" },
    { label: t("tabs.shipping"), id: "shipping" },
    { label: t("tabs.payment"), id: "payment" },
  ];
